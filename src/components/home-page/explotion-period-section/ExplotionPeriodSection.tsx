                  ...
                  <div className="text-center mt-3 lg:mt-[15px] mx-2 lg:mx-5">
                    ...
                    >
                      <button
                        ...
                        border-2 lg:border-3 border-white rounded-2xl lg:rounded-2xl
                        /* Font size & Padding thu nhỏ */
                        text-[16px] lg:text-[30px] font-bold 
                        px-4 lg:px-12 py-2 mt-3 lg:mt-5
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className={`text-white text-center mt-15 z-10`}>
            <div
            ...
            <div
              className={`font-bold w-18/20 lg:w-15/20 text-[clamp(14px,8.59px+1.375vw,35px)] mx-auto lg:mt-5`}
            >
              {lang == "Viet"
        ...
        <div className={`hidden lg:block`}>
          ...
          />
          <div
            className={`lg:text-[clamp(45px,-15px+3.9vw,60px)] font-bold text-center 
        ...
        <div className={`block lg:hidden`}>
          ...
          />
          <div
            className={`lg:text-[clamp(45px,-15px+3.9vw,60px)] font-bold text-center mt-5
            bg-clip-text text-transparent bg-linear-to-r from-[#F3C85F] from-26% via-[#FFECBF] via-66% to-[#C28900]`}
          >
            {lang == "Viet"
              ? "TƯ DUY PHÁT TRIỂN DOANH"
          ...
          <Image
            ...
            alt="Streak Mobile Image"
            className={`w-19/20 h-auto mx-auto mt-5`}
          />
        </div>
        ...
        <div
          className={`
          relative z-10
          text-[clamp(25px,14.705px+2.619vw,65px)] text-balance text-center my-10 mt-15
          bg-linear-to-r from-[#F3C85F] from-26% via-[#FFECBF] via-66% to-[#C28900]
          bg-clip-text text-transparent font-bold
          `}
        >
        ...
        />
        <div
          className={`flex flex-col lg:flex-row mt-15 lg:mt-30 relative z-20`}
        >
          <div
      ...
      <Image
        ...
        className={`w-full h-auto block lg:hidden -mt-10`}
      />
    </>
  );
};
